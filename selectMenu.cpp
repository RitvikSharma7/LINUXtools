...
std::string getMessage() { return "This is a string return!"; }

int main() {

    std::map<std::string, std::any> options;
    options["Greet"] = std::function<void()>(greet);
    options["Get Number"] = std::function<int()>(getNumber);
    options["Get Message"] = std::function<std::string()>(getMessage);
